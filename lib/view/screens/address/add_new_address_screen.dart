...
class AddNewAddressScreen extends StatefulWidget {
  ...
  AddNewAddressScreen(
      {this.isEnableUpdate = true, this.address, this.fromCheckout = false});
...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  _initLoading() async {
    ...
    if (widget.isEnableUpdate && widget.address != null) {
      ...
      _contactPersonNameController.text = _userModel == null
          ? ''
          : '${_userModel.fName}' ' ${_userModel.lName}';
      _contactPersonNumberController.text =
          _userModel == null ? '' : _userModel.phone;
    }
  }
  ...
  Widget _map(BuildContext context, LocationProvider locationProvider) {
    final _branch = Provider.of<SplashProvider>(context, listen: false)
        .configModel
        .branches[0];
    return Container(
